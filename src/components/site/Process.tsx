  ...
  return (
    <section id="process" className="relative py-24 md:py-32">
      <div className="container mx-auto px-4">
        ...
        <StaggerGroup className="grid md:grid-cols-2 lg:grid-cols-4 gap-5 relative">
          {steps.map((s, i) => (
            <StaggerItem key={s.n} className="relative">
              <div className="glass rounded-2xl p-7 h-full hover:border-electric/40 hover:-translate-y-1 transition-all duration-300">
